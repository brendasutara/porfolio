...
export const Works = () => {
  ...
  const text = `Estos trabajos reflejan mi enfoque para 
  diseñar y desarrollar productos digitales claros, 
  funcionales y centrados en el usuario.`;
  ...
  return (
    <section id="trabajos" className="flex flex-col min-h-screen">
      <AnimatedHeaderSection
        subTitle={"Algunos proyectos seleccionados"}
        title={"Trabajos"}
        text={text}
          ...
          >
            ...
            <div className="relative flex items-center justify-center px-10 md:hidden h-100">
              ...
              <img
                ...
                className="absolute bg-center px-14 rounded-xl object-cover h-4/5"
              />
            </div>
          </div>
        ))}
